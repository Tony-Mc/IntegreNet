...
{
    public class DiscardTemplateAsyncTests
    {
        ...
        [Test]
        public async Task DiscardTemplateAsync_WhenSuccessful_ReturnsTemplate()
        {
            // arrange
            ...
            // act
            await _integre.DiscardTemplateAsync("123");

            // assert
            _handlerMock.VerifySendAsync(HttpMethod.Delete, "http://localhost/api/v1/templates/123", null, Times.Once());
        }

        [Test]
        public void DiscardTemplateAsync_WhenUnexpectedStatusCodeIsReturned_Throws()
        {
            // arrange
            _handlerMock.SetupSendAsync(new HttpResponseMessage
            {
            ...
            // act
            var exception = Assert.ThrowsAsync<IntegreException>(async () => await _integre.DiscardTemplateAsync("123"));
        ...
        [Test]
        public void DiscardTemplateAsync_WhenUnexpectedExceptionOccurs_Throws()
        {
            // arrange
