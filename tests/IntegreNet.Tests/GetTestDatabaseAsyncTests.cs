...
{
    public class GetTestDatabaseAsyncTests
    {
        ...
        [Test]
        public async Task GetTestDatabaseAsync_WhenSuccessful_ReturnsTemplate()
        {
            // arrange
            ...
            // act
            var template = await _integre.GetTestDatabaseAsync("123");
            ...
            _handlerMock.VerifySendAsync(HttpMethod.Get, "http://localhost/api/v1/templates/123/tests", null, Times.Once());
        }

        [Test]
        public void GetTestDatabaseAsync_WhenUnexpectedStatusCodeIsReturned_Throws()
        {
            // arrange
            _handlerMock.SetupSendAsync(new HttpResponseMessage
            {
            ...
            // act
            var exception = Assert.ThrowsAsync<IntegreException>(async () => await _integre.GetTestDatabaseAsync("123"));
        ...
        [Test]
        public void GetTestDatabaseAsync_WhenUnexpectedExceptionOccurs_Throws()
        {
            // arrange
